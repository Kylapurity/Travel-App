  ...
  return (
    <div>
      ...
      <div className='absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p-4 pt-15'>
        ...
        <form
          className='max-w-[700px] mx-auto w-full border p-1 rounded-md text-black bg-gray-100/90'
        >
          <div className='flex items-center'>
            <input
              className='bg-transparent w-[300px] sm:w-[400px] font-[Poppins] focus:outline-none flex-1'
              type='text'
